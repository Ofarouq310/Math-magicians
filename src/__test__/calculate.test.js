...
describe('testing calculators functionalities', () => {
  ...
  test('test +/- button', () => {
    ...
    expect(calculate(operands, buttonSelected)).toStrictEqual({ total: 0, next: '-100', operation: null });
  });
  ...
  test('multiplication operator', () => {
    ...
    expect(calculate(operands, buttonSelected)).toStrictEqual({ total: '100', next: null, operation: 'x' });
  });
